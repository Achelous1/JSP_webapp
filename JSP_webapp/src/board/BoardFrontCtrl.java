...
public class BoardFrontCtrl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 글 삭제
		else if(cmdURI.equals("/boardDelete.bctrl")){
		...
		// 검색
		else if(cmdURI.equals("/boardSearch.bctrl")){
			cmd = new BoardSearchCmd();
			cmd.execute(request, response);
		...
		// 답글 작성 화면
		else if(cmdURI.equals("/boardReplyForm.bctrl")){
		...
		//답글 처리
		else if(cmdURI.equals("/boardReply.bctrl")){
